...
def assign_group(closed_date, now):
    """Bucket closed dates into This Month / Previous Month / All Before."""
...
def main():
    ...
    df['group'] = df['closed_at'].apply(lambda d: assign_group(d, now))
    ...
    # Compute summary statistics for this month's data.
    ...
    if not this_month_data.empty:
        ...
        title = (
            f"Latency Distribution (n={count}, open={open_pr_count}, "
